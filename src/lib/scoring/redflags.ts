...
const RULES: Rule[] = [
  ...
  { id: "unpaid", severity: "high", pattern: /\bunpaid\b|\bno pay\b|volunteer basis/i, title: "Unpaid work mentioned", detail: "The posting refers to unpaid work. Unpaid trials for regular jobs are not permitted in Ontario." },
  ...
  { id: "salary_missing", severity: "medium", pattern: /competitive (?:salary|compensation|pay|wage)|salary (?:commensurate|doe|to be discussed|negotiable)|\bDOE\b|based on experience/i, title: "Salary described, not stated", detail: "Ontario's pay transparency rules expect a range on most postings. “Competitive” is a negotiation disadvantage for you." },
  ...
  { id: "authorization", severity: "info", pattern: /legally (?:entitled|eligible|authorized|authorised) to work|work (?:permit|authorization|authorisation)|permanent resident|citizenship/i, title: "Work-authorization attestation", detail: "You will be asked to attest to your status. Answer this yourself; it is never pre-filled for you." },
